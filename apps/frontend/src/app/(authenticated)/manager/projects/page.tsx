  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Proyectos del Equipo</h1>
      ...
      <div className="space-y-3">
        {data?.items.map((project) => (
          <Card key={project.id} className="cursor-pointer hover:border-primary transition-colors" onClick={() => router.push(`/manager/projects/${project.id}`)}>
            <CardContent className="p-4">
