...
import type { AdminTeamResponse, TeamCreate, TeamUpdate } from "../services/team-service";
...
export function TeamFormModal({
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (mode === "create") {
      const data: TeamCreate = { name, ...(managerId && { manager_id: managerId }) };
      onSubmit(data);
    } else {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={mode === "create" ? "Crear equipo" : "Editar equipo"}
